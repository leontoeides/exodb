...
pub trait Serializable {
    ...
    /// * `OnRead` · Use this when the data being written is always already serialized. Data will
    ///   be deserialized on read.
    /// * `OnWrite` · Serialize on write and return serialized data for furtherance, for example,
    ///   to another node.
