//! Provides errors for encryption layer parameters.

// -------------------------------------------------------------------------------------------------
//
/// Represents an error from the encryption layer's parameters module. Parameters provide the
/// information necessary to process encryption layers.
