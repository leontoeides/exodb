...
mod error;
pub use crate::layers::correctors::reed_solomon::error::Error;

pub mod parameters;
pub use crate::layers::correctors::reed_solomon::parameters::Parameters;

mod reed_solomon;
pub use crate::layers::correctors::reed_solomon::reed_solomon::ReedSolomon;
