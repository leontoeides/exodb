...
impl TryFrom<&u16> for &'static Layer {
...
mod tests {
    ...
    fn test_layer_roundtrip() {
        ...
        for layer in layers {
            // Convert to u16
            let as_u16: u16 = layer as u16;

            // Convert back via TryFrom
            let recovered = <&Layer>::try_from(&as_u16)
    ...
    fn test_layer_values() {
        ...
        assert_eq!(Layer::Raw as u16, 0);
        assert_eq!(Layer::Serialization as u16, 1);
        assert_eq!(Layer::Compression as u16, 2);
        assert_eq!(Layer::Encryption as u16, 3);
        assert_eq!(Layer::Correction as u16, 4);
    }
